...
img3 = cv.circle(img2_roi, (avgX, avgY), radius=4, color=(255, 255, 255), thickness=3)
cv.imshow('third_image', img3)

cv.waitKey(0)

# read next set of images
img1 = img2
img2 = cv.imread(folder_dir + imNames[2], cv.IMREAD_GRAYSCALE)
